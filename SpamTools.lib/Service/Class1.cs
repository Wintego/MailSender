...
namespace GeneratedCode
{
    public class GeneratedClass
    {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph3 = new Paragraph() { RsidParagraphAddition = "00BE7595", RsidParagraphProperties = "009F4DB5", RsidRunAdditionDefault = "009233DB" };
            ...
            Paragraph paragraph4 = new Paragraph() { RsidParagraphAddition = "009F4DB5", RsidParagraphProperties = "009F4DB5", RsidRunAdditionDefault = "009F4DB5" };
            ...
            Paragraph paragraph5 = new Paragraph() { RsidParagraphAddition = "009F4DB5", RsidParagraphProperties = "009F4DB5", RsidRunAdditionDefault = "009F4DB5" };

            ParagraphProperties paragraphProperties4 = new ParagraphProperties();
            Indentation indentation3 = new Indentation() { Start = "360" };

            paragraphProperties4.Append(indentation3);

            Run run3 = new Run();
            Text text3 = new Text();
            text3.Text = "Получатель2";
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidR = "009F4DB5" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            Rsid rsid2 = new Rsid() { Val = "009F4DB5" };
            Rsid rsid3 = new Rsid() { Val = "00AC052F" };
            Rsid rsid4 = new Rsid() { Val = "00BC63F3" };
            Rsid rsid5 = new Rsid() { Val = "00BE7595" };
            Rsid rsid6 = new Rsid() { Val = "00C65A67" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "70B2025C" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            Rsid rsid7 = new Rsid() { Val = "009233DB" };
            ...
            Rsid rsid8 = new Rsid() { Val = "009233DB" };
            ...
            Rsid rsid9 = new Rsid() { Val = "00BC63F3" };
        ...
        private void GenerateNumberingDefinitionsPart1Content(NumberingDefinitionsPart numberingDefinitionsPart1)
        {
            ...
            Indentation indentation5 = new Indentation() { Start = "720", Hanging = "360" };
            ...
            Indentation indentation10 = new Indentation() { Start = "4320", Hanging = "360" };
            ...
            Indentation indentation13 = new Indentation() { Start = "6480", Hanging = "360" };
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2019-01-22T12:04:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
